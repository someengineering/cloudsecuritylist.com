    ...
    <>
      ...
      {(featuredPages ?? []).length > 0 ? (
        ...
        >
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
              ...
              return (
                ...
                >
                  <div className="md:flex-shrink-0">
                    <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-cyan-50/50 group-hover:bg-cyan-50/75">
                      <Icon className="h-8 w-8 text-cyan-700 group-hover:text-cyan-800" />
                    </div>
                  </div>
