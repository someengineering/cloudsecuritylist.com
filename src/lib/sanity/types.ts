...
// Query: *[    _type == "openSourceProject" &&    slug.current == $slug  ][0] {    _createdAt,    "_updatedAt":   [    { "timestamp": _updatedAt },    { "timestamp": *[_type == "organization" && organizationType == "acquired" && _id == ^.organization._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "productCategory" && _id in ^.productCategories[]._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "cloudProvider" && _id in ^.supportedCloudProviders[]._ref] | order(_updatedAt desc) [0]._updatedAt },  ],        _id,  "slug": slug.current,  name,  description,  repository,  mark,  logo,  productCategories[] -> {   _id,  "slug": slug.current,  name,  expansion,  description,  marketSegment -> {   _id,  "slug": slug.current,  name,  description,  "icon": icon.name, }, },  supportedCloudProviders[] -> {   _id,  "slug": slug.current,  name,  abbreviation,  description,  "icon": icon.name,  mark,  logo,  website,  linkedin, },    organization -> {   _id,  "slug": slug.current,  name,  description,  organizationType,  website,  linkedin,  crunchbase,  stockSymbol,  mark,  logo, },  } { ..., "_updatedAt": coalesce(_updatedAt | order(coalesce(timestamp, "") desc) [0].timestamp, "") }
...
// Query: *[ _type == "siteSettings" && _id == "siteSettings" ][0] {    "items":      [{ url, "lastModified": _updatedAt }] +      (*[_type == "page" && defined(slug.current) && (!defined(unlisted) || unlisted == false)] | order(slug.current asc) {        "url": ^.url + "/" + slug.current,        "lastModified":   [    { "timestamp": _updatedAt },    select(defined(listType) => { "timestamp": *[_type == ^.listType] | order(_updatedAt desc) [0]._updatedAt }),  ],      } { url, "lastModified": coalesce(lastModified | order(coalesce(timestamp, "") desc) [0].timestamp, "") }) +      (*[_type == "productCategory" && defined(slug.current)] | order(slug.current asc) {        "url": ^.url + "/category/" + slug.current,        "lastModified":   [    { "timestamp": _updatedAt },    { "timestamp": *[_type == "marketSegment" && _id == ^.marketSegment._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "organization" && organizationType != "acquired" && ^._id in productCategories[]._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "openSourceProject" && ^._id in productCategories[]._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "productCategory" && _id in ^.similarCategories[]._ref] | order(_updatedAt desc) [0]._updatedAt },  ],      } { url, "lastModified": coalesce(lastModified | order(coalesce(timestamp, "") desc) [0].timestamp, "") }) +      (*[_type == "organization" && defined(slug.current) && organizationType != "acquired"] | order(slug.current asc) {        "url": ^.url + "/organization/" + slug.current,        "lastModified":   [    { "timestamp": _updatedAt },    { "timestamp": *[_type == "organization" && organizationType == "acquired" && parentOrganization._ref == ^._id] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "productCategory" && _id in ^.productCategories[]._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "cloudProvider" && _id in ^.supportedCloudProviders[]._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "openSourceProject" && organization._ref == ^._id] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "research" && organization._ref == ^._id] | order(_updatedAt desc) [0]._updatedAt },  ],      } { url, "lastModified": coalesce(lastModified | order(coalesce(timestamp, "") desc) [0].timestamp, "") }) +      (*[_type == "openSourceProject" && defined(slug.current) && name != organization->name] | order(slug.current asc) {        "url": ^.url + "/open-source/" + slug.current,        "lastModified":   [    { "timestamp": _updatedAt },    { "timestamp": *[_type == "organization" && organizationType == "acquired" && _id == ^.organization._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "productCategory" && _id in ^.productCategories[]._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "cloudProvider" && _id in ^.supportedCloudProviders[]._ref] | order(_updatedAt desc) [0]._updatedAt },  ],      } { url, "lastModified": coalesce(lastModified | order(coalesce(timestamp, "") desc) [0].timestamp, "") }) +      (*[_type == "cloudProvider" && defined(slug.current)] | order(slug.current asc) {        "url": ^.url + "/provider/" + slug.current,        "lastModified":   [    { "timestamp": _updatedAt },    { "timestamp": *[_type == "organization" && organizationType != "acquired" && ^._id in supportedCloudProviders[]._ref] | order(_updatedAt desc) [0]._updatedAt },    { "timestamp": *[_type == "openSourceProject" && ^._id in supportedCloudProviders[]._ref] | order(_updatedAt desc) [0]._updatedAt },  ],      } { url, "lastModified": coalesce(lastModified | order(coalesce(timestamp, "") desc) [0].timestamp, "") })  }.items
